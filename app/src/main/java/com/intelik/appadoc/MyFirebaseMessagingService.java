...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(String newToken) {
        ...
        Common.getInstance().Token = newToken;
        //Common.getInstance().saveToken(newToken);
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            if (remoteMessage.getNotification().getImageUrl() != null) {
                Uri Uriimage = remoteMessage.getNotification().getImageUrl();
            ...
            if (remoteMessage.getData().get("Message") != null){
                desc = remoteMessage.getData().get("Message");
            }
     ...
     NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, "Seasame");
        mBuilder.setContentTitle(title)
            .setContentText(messageBody)
                .setSmallIcon(R.drawable.ico_info_small)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.ico_info_small))
            .setAutoCancel(true)
